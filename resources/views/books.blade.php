...
<tbody>
        ...
        <div class="alert alert-info">
            ...
            <tr>
                <th>
                        <?php echo $booklist['id']; ?>
                </th>
                <th>
                        <img src="storage/{{$booklist->image}}" width="100px" alt="image" style="max-width: 60px">
                </th>
                <th>
                        <?php echo $booklist['name']; ?>
                </th>
                <th>
                        <?php echo $booklist['author']; ?>
                </th>
                <th>
                        <?php echo $booklist['years']; ?>
                </th>
                <th>
                    <a href="{{ route('detailsbook',$booklist->id)}}">
